...
<div class="rol-view">
    ...
    <?= $form->field($model, 'tipo_reporte')->dropDownList(['0' => 'Por Horas', '1' => 'Por Contrato', '2' => 'Por Asesor']); ?>

    <?php ActiveForm::end(); ?>

    <div class="form-group">
        <button class='btn btn-success' onclick="carga_ servicios()">Buscar</button>
    </div>
...
<script type='text/javascript'>
    function carga_servicios() {
        var cliente = trae('reportefacturacionform-id_cliente').value;
        var usuario = trae('reportefacturacionform-id_usuario').value;
        var fecha_inicial = trae('reportefacturacionform-fecha_inicial').value;
        var fecha_final = trae('reportefacturacionform-fecha_final').value;
